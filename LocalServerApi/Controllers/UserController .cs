...
namespace IdentityService.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpPost("register")]
        public IActionResult Register([FromBody] AuthTokenRequest authRequest)
        {
            ...
            _context.usersaveddata.Add(user);
        ...
        public IActionResult Authenticate([FromBody] AuthTokenRequest authRequest)
        {
            var user = _context.usersaveddata.FirstOrDefault(u => u.Email == authRequest.Email);
